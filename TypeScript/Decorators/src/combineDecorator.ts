...
function Cry2(how: string){
    console.log('Cry2 팩토리'); // 1
    return function(constructor: Function){
        console.log(" 여기는 Cry 데코레이터 "); // 5
        console.log(how); // 6
...
/*
    ...
    @g
    test
    수학적으로 f(g(x)) 와 같다 ==> 내가 이해한 내용은 함수내의 모든 것이라고 생각했는데 데코레이터는 사실 고차함수
                                    안에 넣어둔 리턴 함수의 결과값이 내가 생각한 g(x)의 값인 것이다!
